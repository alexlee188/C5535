...
/** USB EP maximum packet size in full speed mode, isochronous  transfer     */
#define CSL_USB_EP_MAX_PACKET_SIZE_ISO_FS           (1023)
/** USB EP maximum packet size in high speed mode, isochronous  transfer     */
#define CSL_USB_EP_MAX_PACKET_SIZE_ISO_HS           (1024)

/** USB EP maximum packet size in full speed mode, interrupt transfer     */
#define CSL_USB_EP_MAX_PACKET_SIZE_INT_FS           (64)
/** USB EP maximum packet size in high speed mode, isochronous  transfer     */
#define CSL_USB_EP_MAX_PACKET_SIZE_INT_HS           (1024)
...
/** \brief Standard USB requests for audio class 2.0                             */
/** USB request to get/set current                                               */
#define CSL_USB_CUR                             (0x01)
/** USB request to get/set range                                               */
#define CSL_USB_RANGE                             (0x02)
/** USB request to get/set memory                                               */
#define CSL_USB_MEM                             (0x03)
...
/** \brief  USB device qualifier Descriptor Type Value                       */
...
typedef struct CSL_UsbContext {
	...
	/** \brief  TRUE, if self-powered USB device                             */
    Bool                    selfPowered;
    ...
    WORD                    wOutEP0Buf[CSL_USB_MAX_OUTEP0BUF_LEN / 2];
	...
	Bool                     usbSpeedCfg;
	Uint16					 alt_setting_rec;
	Uint16					 alt_setting_play;
} CSL_UsbContext;
...
/** ============================================================================
 *   @n@b USB_getSelfPowered
 *
 *   @b Description
 *   @n This function returns whether the device is self powered.
 *      This is to inform the host about the device status.
 ...
 *   @verbatim
     ...
     @endverbatim
 *
 *   <b> Return Value </b> Whether device is self powered
 *
 *   <b> Pre Condition </b>
 *   @n  USB_init function should be called successfully
 *
 *   <b> Post Condition </b>
 *   @n  Returns whether device is self powered
 *
 *   @b Modifies
 *   @n None
 *
 ...
 *   @verbatim
            ...
            status = USB_init(&usbConfig);
            .....
            selfPowered = USB_getSelfPowered(CSL_USB0);
     @endverbatim
 *  ============================================================================
 */
Bool USB_getSelfPowered(CSL_UsbDevNum    devNum);
...
/** ============================================================================
 *   @n@b USB_setHighSpeedMode
 *
 *   @b Description
 *   @n This function is used to set the USB controller into high speed mode
 *      ep0DataSize is the size of the EP0 FIFO. This value should be within
 *      the range of values recommended by the USB specification.
 *
 *   @b Arguments
 ...
 *
 *   <b> Post Condition </b>
 *   @n  USB will be set for high speed mode
 *
 *   @b Modifies
 *   @n USB registers
 *
 ...
 *   @verbatim
            ...
            ....
            ....
            USB_setHighSpeedMode(0x20);

     @endverbatim
 *  ============================================================================
 */
void USB_setHighSpeedMode(Uint16    ep0DataSize);
