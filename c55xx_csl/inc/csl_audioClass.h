...
/** USB AC Human Interface Device report descriptor type macro               */
#define CSL_AC_HID_REPORT_DESCRIPTOR_TYPE                     (0x22)
...
#define CSL_AC_CONFIG_DESCR_MAX_LEN                           (400)
...
#define CSL_AC_HID_REPORT_DESCR_MAX_LEN                       (67+2)
...
/** Maximum allowed length of HID report descriptor                          */
#define CSL_AC_HID_REPORT_DESCR_MAX_LEN_W                     ((CSL_AC_HID_REPORT_DESCR_MAX_LEN+1)/2)

/** HID Input report type (Get Report request)                               */
#define CSL_AC_HID_INPUT_REPORT_TYPE                          (0x01)
/** HID Ouput report type (Get Report request)                               */
#define CSL_AC_HID_OUTPUT_REPORT_TYPE                         (0x02)
/** HID Feature report type (Get Report request)                             */
#define CSL_AC_HID_FEATURE_REPORT_TYPE                        (0x03)
...
#define CSL_AC_NO_ENDPTOBJECT                                  (6)
...
/** Host request to get CUR using control transfer                    */
#define CSL_AC_REQUEST_GET_CUR									(0xA001)
/** Host request to get RANGE using control transfer                                   */
#define CSL_AC_REQUEST_GET_RANGE								(0xA002)
/** Host request to get MEM using control transfer                                   */
#define CSL_AC_REQUEST_GET_MEM									(0xA003)
/** Host request to set CUR using control transfer                    */
#define CSL_AC_REQUEST_SET_CUR									(0x2001)
/** Host request to set RANGE using control transfer                                   */
#define CSL_AC_REQUEST_SET_RANGE								(0x2002)
/** Host request to set MEM using control transfer                                   */
#define CSL_AC_REQUEST_SET_MEM									(0x2003)
/** Host request to get HID report using control transfer                    */
#define CSL_AC_REQUEST_HID_GET_REPORT                         (0xA001)
/** Host request to get idle rate from HID                                   */
#define CSL_AC_REQUEST_HID_GET_IDLE                           (0xA002)
/** Host request to get idle rate from HID                                   */
#define CSL_AC_REQUEST_HID_GET_PROTOCOL                       (0xA003)
/** Host request to send HID report using control transfer                   */
#define CSL_AC_REQUEST_HID_SET_REPORT                         (0x2009)
/** Host request to set HID idle rate                                        */
#define CSL_AC_REQUEST_HID_SET_IDLE                           (0x200A)
/** Host request to specify whether HID should use boot or report protocol   */
#define CSL_AC_REQUEST_HID_SET_PROTOCOL                       (0x200B)
/** Audio Class Volume controlBuffer Length                                  */
#define CSL_AC_VOLUME_CTRL_BUF_LEN                            (4)
/** Audio Class Feature Unit Mute Control request ID                         */
#define CSL_AC_MUTE_CTRL_BUF_LEN                              (4)
/** Audio Class Feature Unit Mute Control request ID                         */
#define CSL_AC_SAMP_RATE_CTRL_BUF_LEN                         (3)
/** Audio Class Feature Unit Mute Control request ID                         */
...
/** Audio Class Feature Unit master Control request ID            */
#define USB_AC_FEATURE_UNIT_MASTER							(0x00)
/** Audio Class Feature Unit left Control request ID                  */
#define USB_AC_FEATURE_UNIT_LEFT                       		(0x01)
/** Audio Class Feature Unit right Control request ID                 */
#define USB_AC_FEATURE_UNIT_RIGHT                      		(0x02)
...
typedef struct CSL_AcInitStructApp {
    ...
    Uint16                 numLun;
    /** \brief  Tx Isochronous endpoint number (1-15)                        */
    Uint16                 txEpNum;
    /** \brief  Rx Isochronous endpoint number (1-15)                        */
    Uint16                 rxEpNum;
    /** \brief  Tx HID interrupt endpoint number (1-15)                      */
    Uint16                 hidTxEpNum;
#ifdef FEEDBACKEP
    /** \brief  feedback Isochronous endpoint number (1-15)                        */
    Uint16                 fbEpNum;
#endif //FEEDBACKEP
    ...
    Uint16                 hidTxPktSize;
#ifdef FEEDBACKEP
    /** \brief  Size of the Tx packet for feedback ISO end point            */
    Uint16                 fbckTxPktSize;
#endif //FEEDBACKEP
    ...
    /** \brief  Pointer to the request Table which is specified by user for HID      */
    CSL_AcRequestStruct    *acReqTableAppHID;
    ...
    /** \brief  Function to initialize audio playback                        */
    CSL_Status             (*initPlayAudioApp)(Uint16 , void*);
    /** \brief  Function to initialize audio record                          */
    CSL_Status             (*initRecordAudioApp)(Uint16 , void*);
    /** \brief  Function to stop audio playback                              */
    CSL_Status             (*stopPlayAudioApp)(Uint16 , void* );
    /** \brief  Function to stop audio record                               */
    CSL_Status             (*stopRecordAudioApp)(Uint16 , void* );
    ...
    Uint16                 acHidIfNum;
    /** \brief  Audio Class HID report ID                                    */
    Uint16                 acHidReportId;
    /** \brief  Audio Class HID report length                                */
    Uint16                 acHidReportLen;
} CSL_AcInitStructApp;
...
typedef struct CSL_AcObject {
    ...
    /** \brief  Function to record audio data                                */
    CSL_AcMediaStatus    (*recordAudio)(Uint16 , Uint16* , Uint16*, void*);
    /** \brief  Function to initialize audio playback                        */
    CSL_Status           (*initPlayAudio)(Uint16 , void*);
    /** \brief  Function to initialize audio record                          */
    CSL_Status           (*initRecordAudio)(Uint16 , void*);
    /** \brief  Function to stop audio playback                              */
    CSL_Status           (*stopPlayAudio)(Uint16 , void*);
    /** \brief  Function to stop audio record                                */
    CSL_Status           (*stopRecordAudio)(Uint16 , void*);
    ...
    /** \brief  HID Interrupt In Endpoint Object                             */
    CSL_UsbEpObj         hidIntInEpObj;
#ifdef FEEDBACKEP
    /** \brief  Iso Out feedback Endpoint Object                                      */
    CSL_UsbEpObj         isoFbckEpObj;
#endif //FEEDBACKEP
    ...
    /** \brief  Flag to track the status of audio record                     */
    Uint16               recordActive;
...
typedef struct CSL_AcCtrlObject {
    ...
    CSL_UsbSetupStruct     usbSetup;
    /** \brief  Buffer to hold playback left volume information              */
    Uint16                 leftVolBuf[CSL_AC_VOLUME_CTRL_BUF_LEN];
    /** \brief  Buffer to hold playback right volume information             */
    Uint16                 rightVolBuf[CSL_AC_VOLUME_CTRL_BUF_LEN];
    /** \brief  Buffer to hold playback left and right volume information    */
    Uint16                 leftRightVolBuf[2*CSL_AC_VOLUME_CTRL_BUF_LEN];
    /** \brief  Buffer to hold record left volume information              */
    Uint16                 recordleftVolBuf[CSL_AC_VOLUME_CTRL_BUF_LEN];
    /** \brief  Buffer to hold record right volume information             */
    Uint16                 recordrightVolBuf[CSL_AC_VOLUME_CTRL_BUF_LEN];
    /** \brief  Buffer to hold record left and right volume information    */
    Uint16                 recordleftRightVolBuf[2*CSL_AC_VOLUME_CTRL_BUF_LEN];
    /** \brief  Buffer to hold playback mute ctrl information                */
    Uint16                 muteCtrlBuf[CSL_AC_MUTE_CTRL_BUF_LEN];
    /** \brief  Buffer to hold record mute ctrl information                  */
    Uint16                 recordmuteCtrlBuf[CSL_AC_MUTE_CTRL_BUF_LEN];
    /** \brief  Buffer to hold playback endpoint sample ctrl information     */
    Uint16                 sampleRateBuf[CSL_AC_SAMP_RATE_CTRL_BUF_LEN];
    /** \brief  Buffer to hold record endpoint sample ctrl information     */
    Uint16                 recSampleRateBuf[CSL_AC_SAMP_RATE_CTRL_BUF_LEN];
    ...
    /** \brief  Pointer to the request Table for HID                                 */
    CSL_AcRequestStruct    *acReqTableHID;
    /** \brief  Request handler function pointer                             */
    CSL_AcRequestRet        (*fpRequestHandler)(CSL_AC_REQUEST_ARGS);
    /** \brief  Audio Class HID report descriptor length                     */
    Uint16                 audioClassHidReportDescrLen;
    /** \brief  Audio Class HID report descriptor                            */
    Uint16                 audioClassHidReportDescr[CSL_AC_HID_REPORT_DESCR_MAX_LEN_W];
    /** \brief  Audio Class HID interface number                             */
    Uint16                 acHidIfNum;
    /** \brief  Audio Class HID report ID                                    */
    Uint16                 acHidReportId;
    /** \brief  Audio Class HID report length                                */
    Uint16                 acHidReportLen;
    /** \brief  Audio Class HID idle rate                                    */
    Uint16                 acHidIdleRate;
} CSL_AcCtrlObject;
...
extern Int16 numPbSamps;
extern Int16 numRecSamps;

extern Bool gPbSampRateChange; // playback sample rate change flag
extern Bool mute_flag_change;
extern Bool playback_volume_flag_change_Left;
extern Bool playback_volume_flag_change_Right;
