...
#if 0 // FL: USB AC record only + VCP
// The Configuration Descriptor
#pragma DATA_ALIGN(configDescriptor, 4);
const Uint16 configDescriptor[CONFIG_DESCR_SZ] =
{
...
/* End of Class-Specific AudioControl Interface Descriptor section */
    ...
    /* CDC ACM (VCP) Interface */
    /* Interface 0 descriptor */
    0x09,           /* size of interface 0 */
    0x04,           /* interface descriptor type */
    IF_NUM_COMM,    /* interface number */
    0x00,           /* alternate setting number */
    0x01,           /* number of endpoints in this interface */
    0x02,           /* Class code (2: communication interface class code) */
    0x02,           /* Sub-class code (2: ACM) */
    0x01,           /* Protocol code (V.25) */
    0x00,	        /* interface string index */
    /* CDC Class-Specific Descriptors */
    0x04,           /* size of this functional descriptor */
    0x24,	        /* descriptor type (CS_INTERFACE) */
    0x02,           /* ACM functional descriptor subtype */
    0x02,           /* capabilities (D1) */
    // Endpoint descriptor for communication interface (INTR EP IN)
    0x07,           /* endpoint decsriptor size */
    0x05,           /* USB endpoint descriptor type */
    0x80|CSL_CDC_INTR_IN_EP, /* INTR EP IN */
    0x03,           /* attributes (3: Interrupt) */
    LEB(0x0040),    /* maximum packet size 64 */
    0x02,           /* polling interval */
    // Interface 1 descriptor    
    0x09,	        /* size of interface 1 */
    0x04,           /* interface descriptor type */
    IF_NUM_DATA,    /* interface number */
    0x00,           /* alternate setting number */
    0x02,           /* number of endpoints in this interface */
    0x0A,           /* Class code (0x0A: Data interface) */
    0x00,           /* Sub-class code */
    0x00,           /* Protocol code */
    0x00,           /* interface string index */
    // Endpoint descriptor for data interface (BULK EP IN)
    0x07,           /* endpoint descriptor size */
    0x05,           /* USB endpoint descriptor type */
    0x80|CSL_CDC_BULK_IN_EP, /* BULK EP IN */
    0x02,           /* attributes (2: Bulk) */
    LEB(0x0040),    /* maximum packet size 64 */
    0x00,	        /* polling interval */
    // Endpoint descriptor for data interface (BULK EP OUT)
    0x07,	        /* endpoint descriptor size */
    0x05,           /* USB endpoint descriptor type */
    CSL_CDC_BULK_OUT_EP, /* BULK EP OUT */
    0x02,           /* attributes (2: Bulk) */
    LEB(0x0040),    /* maximum packet size 64 (lower byte) */
    0x00            /* polling interval */
};
#endif

#if 1 // FL: USB AC record only + VCP (/w IAD)
// The Configuration Descriptor
#pragma DATA_ALIGN(configDescriptor, 4);
const Uint16 configDescriptor[CONFIG_DESCR_SZ] =
{
